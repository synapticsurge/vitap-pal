...
Future<LocalDataSource> timetableLocalDataSource(Ref ref) async{
  return LocalDataSource(await ref.read(appDatabaseProvider.future),ref.read(globalAsyncQueueProvider.notifier));
}

@riverpod 
Future<RemoteDataSource> timetableRemoteDataSource(Ref ref) async{
  return RemoteDataSource(await ref.watch(clientProvider.future),ref.read(globalAsyncQueueProvider.notifier));
}