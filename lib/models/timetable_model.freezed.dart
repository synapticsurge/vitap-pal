...
mixin _$TimetableModel implements DiagnosticableTreeMixin {
 ...
 List<Map<String, String>> get timetable; List<Map<String, String>> get uniquedays;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('timetable', timetable))..add(DiagnosticsProperty('uniquedays', uniquedays));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TimetableModel&&const DeepCollectionEquality().equals(other.timetable, timetable)&&const DeepCollectionEquality().equals(other.uniquedays, uniquedays));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(timetable),const DeepCollectionEquality().hash(uniquedays));

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'TimetableModel(timetable: $timetable, uniquedays: $uniquedays)';
}
...
@useResult
$Res call({
 List<Map<String, String>> timetable, List<Map<String, String>> uniquedays
});
...
/// Create a copy of TimetableModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? timetable = null,Object? uniquedays = null,}) {
...
class _TimetableState with DiagnosticableTreeMixin implements TimetableModel {
   _TimetableState({required final  List<Map<String, String>> timetable, required final  List<Map<String, String>> uniquedays}): _timetable = timetable,_uniquedays = uniquedays;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TimetableState&&const DeepCollectionEquality().equals(other._timetable, _timetable)&&const DeepCollectionEquality().equals(other._uniquedays, _uniquedays));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_timetable),const DeepCollectionEquality().hash(_uniquedays));
...
/// Create a copy of TimetableModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? timetable = null,Object? uniquedays = null,}) {
