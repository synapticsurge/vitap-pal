...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [semTable, timetable];
}
...
class $$SemTableTableTableManager
    extends
        RootTableManager<
          ...
          SemTableData,
          PrefetchHooks Function({bool timetableRefs})
        > {
          ...
          withReferenceMapper:
              (p0) =>
                  p0
                      ...
                      .toList(),
          prefetchHooksCallback: ({timetableRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [if (timetableRefs) db.timetable],
              addJoins: null,
