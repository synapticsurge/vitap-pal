...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 368451091;
...
fn wire__crate__api__vtop_main__client_login_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        ...
                        let mut api_iclient_guard = api_iclient_guard.unwrap();
                        let output_ok = Result::<_, ()>::Ok(
                            crate::api::vtop_main::client_login(&mut *api_iclient_guard).await,
                        )?;
                        Ok(output_ok)
                    })()
                    .await,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok =
                            Result::<_, ()>::Ok(crate::api::vtop_main::get_client().await)?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        28 => wire__crate__api__vtop_main__client_login_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__vtop_main__get_client_impl(port, ptr, rust_vec_len, data_len),
